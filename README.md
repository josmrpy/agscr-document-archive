...
El objetivo de este repositorio es mantener estos documentos reunidos en un solo lugar, facilitando su búsqueda y acceso sin tener que descargarlos repetidamente desde el sitio web original.

El archivo contiene documentos provenientes de las diferentes secciones y subsecciones disponibles en la sección pública de **Descargas** de la organización.
...
El scraper de Python utilizado para recopilar los documentos **no está incluido** en este repositorio. Este repositorio está pensado como un archivo documental y no como una herramienta de scraping.

## Actualizaciones

El archivo puede actualizarse periódicamente.

Cuando aparezcan nuevos documentos disponibles públicamente en el sitio web oficial, el archivo podrá actualizarse con los nuevos documentos encontrados. Los documentos que ya se encuentren en el repositorio no se vuelven a descargar intencionalmente.

La intención es que este repositorio se mantenga como una colección actualizada de documentos disponibles públicamente y no solamente como una copia realizada una única vez.

## Fuente

Los documentos son recopilados del sitio web oficial de la Asociación de Guías y Scouts de Costa Rica:
...
La Asociación de Guías y Scouts de Costa Rica es una organización costarricense dedicada a la educación no formal y al desarrollo de oportunidades para la niñez y la juventud mediante su programa educativo.

## Aviso

Este es un **archivo independiente y no oficial**.

Este repositorio no es administrado, mantenido ni respaldado por la Asociación de Guías y Scouts de Costa Rica.

Los documentos contenidos en este repositorio pertenecen a sus respectivos autores y/o titulares de derechos. No se reclama propiedad sobre estos materiales.
